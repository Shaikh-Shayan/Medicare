...
class Home extends Component {
  ...
  render() {
    if (this.state.loading === true) {
          ...
          return (
            <Col sm={4}>
              <Card
                ...
                className="detailbox"
              >
                <Card.Header style={{ fontWeight: 550 }}>
                  {r.transid}
                </Card.Header>
                <Card.Body
                  style={{ backgroundColor: this.state.color[colcou] }}
                >
                  ...
                  <Card.Text>
                    ...
                    <p className="CardContent">{r.name}</p>
                    <p className="CardTitle">Address : </p>
                    <p className="CardContent">{r.from}</p>
                    <p className="CardTitle">To : </p>
                    <p className="CardContent">{r.Toname}</p>
                    {r.to !== undefined ? (
                      <div>
                        <p className="CardTitle">Address : </p>
                        <p className="CardContent">{r.to}</p>
                      </div>
                    ) : null}
                    <p className="CardTitle">Sid : </p>
                    <p className="CardContent"> {r.sid}</p>

                    {r.eid !== undefined ? (
                      <div>
                        {" "}
                        <p className="CardTitle">Eid : </p>
                        <p className="CardContent">{r.eid}</p>
                      </div>
                    ) : null}
                    <p className="CardTitle">Number Of Meds : </p>
                    <p className="CardContent">{r.meds}</p>
                  </Card.Text>
                </Card.Body>
                <Card.Footer>
      ...
      notif = (
        <div className="NURD">
          <h3 className="NUN" style={{ marginTop: 45 }}>
            ...
            return (
              <Col sm={4}>
                ...
                >
                  ...
                  <Card.Body
                    style={{ backgroundColor: this.state.color[colco] }}
                  >
                    {/* <Card.Title>{r.transid}</Card.Title> */}
                    <Card.Text>
                      {
                    ...
                    {r.accepted === false ? (
                      <div>
                        <Button
                          ...
                          className="abut"
                          onClick={() =>
                            this.receiveHandler(r.sid, r.eid, r.from, r._id)
                          }
                          value={r}
                        >
                          Receive
      ...
      if (this.state.typeofuser !== "Retailer")
        nav = (
          <Nav.Link eventKey={1} href="" onClick={this.adddmediHandler}>
            Add Medicine
          </Nav.Link>
        );
      else {
      ...
      if (this.state.typeofuser === "Distributer") nav = "";
      var noN = "";
      let nav1 = "";
      // if (this.state.typeofuser !== 'Manufacturer')
      nav1 = (
        <Nav.Link eventKey={4} href="" onClick={this.notifiHandler}>
          Notification
          {count === 0 ? (
            <sup style={{ fontWeight: 550, color: "red", fontSize: 16 }}>
              {noN}{" "}
            </sup>
          ) : (
            <sup style={{ fontWeight: 550, color: "red", fontSize: 15 }}>
              {count}{" "}
            </sup>
          )}
        </Nav.Link>
      ...
      return (
        <div className="mainhomediv">
          <Navbar collapseOnSelect expand="lg" bg="dark" variant="dark">
            <Navbar.Brand href="" className="IconS">
              Medicare
            </Navbar.Brand>
            ...
            <Navbar.Collapse id="responsive-navbar-nav">
              ...
              <Nav>
                ...
                <Nav.Link
                  ...
                  onClick={this.logout}
                >
                  LogOut <FiLogOut style={{ fontSize: 20, marginBottom: 3 }} />
                </Nav.Link>
              </Nav>
            </Navbar.Collapse>
          </Navbar>
              ...
              <Row>
                ...
                <Col sm>
                  <span className="WelcomeUser">
                    Welcome {this.state.typeofuser}{" "}
                    {this.state.accountName.toUpperCase()}
                  </span>
                </Col>
              </Row>
          ...
          {this.state.addmedi === true ? (
            this.state.typeofuser == "Manufacturer" ? (
              <Container style={{ marginTop: 50 }} className="addmedi">
                ...
                <Row className="addmedirow">
                  <Col sm={3}>
                    <span className="addmediformspan">
                      {" "}
                      Distributer Address :
                    </span>
                  </Col>
              ...
              <Container style={{ marginTop: 50 }} className="addmedi">
                ...
                <Row className="addmedirow">
                  ...
                  <Col sm={9}>
                    <input
                      ...
                      required
                      onChange={this.handleChange}
                      placeholder={this.state.showeid}
                      style={{ textIndent: 10 }}
                    />
                    <br />
                    <br />
                ...
                <Row className="addmedirow">
                  <Col sm={3}>
                    <span className="addmediformspan">
                      {" "}
                      Retailer Address {console.log(this.state)}:
                    </span>
                  </Col>
                  <Col sm={9}>
                    <input
