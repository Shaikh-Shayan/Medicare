                ...
                >
                  <Card.Body>
                    ...
                    <Card.Text>
                      ...
                      <p className="CardContent">{r.address}</p>
                      <p className="CardTitle">Username :</p>{" "}
                      <p className="CardContent">{r.userName}</p>
                      <p className="CardTitle">Account Type :</p>{" "}
                      <p className="CardContent">{r.typeofuser}</p>
                    </Card.Text>
                  </Card.Body>
                  <Card.Footer>
                    <div>
                      ...
                      <Button
                        ...
                        onClick={() => this.declineHandler(r._id)}
                      >
                        Decline
                      </Button>
                    </div>
                ...
                >
                  <Card.Body>
                    ...
                    <Card.Text>
                      ...
                      <p className="CardContent">{r.phone}</p>
                    </Card.Text>
                  </Card.Body>
                  {/* <Card.Footer>
        ...
        <div className="maindiv">
              ...
              <Row>
                <Col sm>
                  <input
                    ...
                    name="Name"
                    className="searchinput"
                    placeholder="Enter Medicine by id"
                    onChange={this.handleChange}
                    style={{ textIndent: 12 }}
                  />
                  <br />
          ...
          {this.state.displayUser === true ? (
            <Container style={{ marginTop: 50 }}>
              <Row>
                ...
                <Col sm>
                  <Card
                    ...
                    style={{ border: "1px solid ", height: "82%" }}
                  >
                    <Card.Body>
                      <Card.Title>
                        <FaRegUser
                          style={{ float: "left", fontSize: 30, marginTop: -5 }}
                        />
                        Total Users: {this.state.displayuserlist.length}{" "}
                      </Card.Title>
                    </Card.Body>
                  </Card>
                </Col>
              ...
              {this.state.manudis === true ? <Row>{dispmanuuser}</Row> : null}

              {this.state.distdis === true ? <Row>{dispdistuser}</Row> : null}

              {this.state.retadis === true ? <Row>{dispretauser}</Row> : null}
            </Container>
          ) : null}
        </div>
      );
...
export default withAuthAdmin(Admin_Home);
